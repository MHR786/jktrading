      ...
      <div className="container mx-auto px-4 md:px-6">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] uppercase tracking-widest text-primary-foreground/70 leading-tight">
                  Global Auto Parts
                </span>
              </div>
            </div>
            <p className="text-sm text-primary-foreground/70 leading-relaxed mb-6">
              Premium genuine and aftermarket Japanese auto parts sourced
              directly from Japan and exported to clients worldwide. Quality,
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-primary-foreground/70">
                  Kyto fu kizugawa shi sato Nishitoriguchi 76 cosmo hights 103
                  Pstal code 619-1151
                </span>
              </li>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-6">
            <span className="text-sm text-primary-foreground/50 hover:text-white cursor-pointer transition-colors">
              Privacy Policy
            </span>
            <span className="text-sm text-primary-foreground/50 hover:text-white cursor-pointer transition-colors">
              Terms of Service
